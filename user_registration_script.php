<?php
    ...
    if($rows_fetched>0){
        ...
        $user_id = $_SESSION['id'];
        $score = 0;
        $user_registration_query_score="insert into score(user_id,score) values ('$user_id','$score')";
        $user_registration_result_score=mysqli_query($con,$user_registration_query_score) or die(mysqli_error($con));
